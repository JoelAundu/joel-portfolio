...
const projects = [
  ...
  },
  {
    ...
    roleKey: 'projects.p5_role',
    descKey: 'projects.p5_desc',
    tech: ['React', 'Vite', 'React Router', 'CSS', 'Vercel'],
    github: null,
    live: 'https://running-rosy.vercel.app/',
    color: '#FF3300',
  },
]
    ...
    <section id="projects" className="section-padding bg-bg-light dark:bg-bg-dark">
      <div className="max-w-6xl mx-auto">
        <motion.div
          ...
          className="mb-16"
        >
          <p className="text-accent font-mono text-sm font-semibold mb-3">04. Projects</p>
